...
use Tridi\Tripay\Support\Constant;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class Tripay extends Container
{
     ...
     * @param String
     * 
     * @return Object Tridi\Tripay
     */
    public function getPaymentChannel($code = [])
    {
    ...
    {
        return $this->curl('/open-payment/'.$data['uuid'].'/transactions',Constant::HTTP_GET,$data);
    }
